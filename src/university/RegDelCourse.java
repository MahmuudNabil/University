 ...
 * @author lapshop
 */
public class RegDelCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("تسجيل او حذف كورس للطالب");
        setResizable(false);
        ...
        setSize(new java.awt.Dimension(852, 546));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegDelCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegDelCourse().setVisible(true);
            }
        });
    }
    ...
    private void tableDataBase() {
        ...
        }catch(Exception e)
        {
            ...
            try {
                ...
                Logger.getLogger(RegDelCourse.class.getName()).log(Level.SEVERE, null, ex);
            }
